...
function NewStudent() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("refrence", student.refrence);
          ...
          <Grid container spacing={2} autoComplete="off">
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                label="Reference"
                name="refrence"
                value={student.refrence}
                onChange={(e) => handleChange("refrence", e.target.value)}
                id={error?.refrence && "refrence-error"}
                error={error?.refrence && true}
                helperText={error?.refrence && error?.refrence?.msg}
              />
            </Grid>
            <Grid item xs={12} align="center">
              <Button
